/* Made by baodaigov.github.io 2022-2023. Please do not copy !!! */
function isMobile() {
	var check = false;
	(function(a){
  ...
  function checkLinkMobile()
  {
	  ...
	  var check = false;
	  if (link.includes("https://baodaigov.github.io/m/") || link.includes("https://baodaigov.github.io/m/") )
		 {
			 check = true;
		 }
		 return check;
  ...
  function changeLinkMobile2Desktop(link)
  {
  ...
  $(function() {	    
		 ...
		 if (checkLinkMobile())
		 {
			 if(!isMobile())
			 {
				 changeLinkMobile2Desktop(linkD);
			 }
		 }
		 ...
		 else
		 {
			 ...
			 if(isMobile())
			 {
				 changeLinkDesktop2Mobile(linkD);
...
// 	  var link = window.location.href;
// 	  var check = false;
// 	  if (link.includes("http://127.0.0.1:5502/m/index.html") || link.includes("http://127.0.0.1:5502/m/") )
// 		 {
// 			 check = true;
// 		 }
// 		 return check;
...
// 	  if (link === ("http://127.0.0.1:5502/index.html") || link === ("http://127.0.0.1:5502/") )
// 	  { 
